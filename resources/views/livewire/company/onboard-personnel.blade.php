    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <form wire:submit="onboard" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.live="phone" type="text" inputmode="numeric" pattern="[0-9]{10}"
                               maxlength="10" placeholder="0244000000" autocomplete="tel"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            @else
                ...
                <div class="mt-4">{{ $recentOnboardings->links() }}</div>
            @endif
        </div>
    </div>
</div>
