<div class="space-y-6">
    <div class="border-b border-gray-100 pb-4">
        ...
        <p class="text-sm text-gray-500 mt-0.5">Access and download your endorsed letters, appointment letters, and onboarding credentials.</p>
    </div>

    {{-- Endorsed posting letters --}}
    <div>
        <h3 class="text-base font-bold text-gray-900 mb-3">Endorsed Posting Letters</h3>
    ...
    {{-- Appointment letters (separate from endorse) --}}
    <div>
        <h3 class="text-base font-bold text-gray-900 mb-3">Appointment Letters</h3>
        @if ($appointmentLetters->isEmpty())
            <div class="bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-sm">
                <p class="text-gray-500 text-sm max-w-sm mx-auto">No appointment letter yet. It will appear here once your company issues one after validation.</p>
            </div>
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @foreach ($appointmentLetters as $letter)
                    <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
                        <div>
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center gap-3">
                                    <div class="p-2.5 bg-emerald-50 rounded-xl text-emerald-700">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                                    </div>
                                    <div>
                                        <h3 class="font-bold text-gray-900 text-base">Appointment Letter</h3>
                                        <p class="text-xs text-gray-400 mt-0.5">
                                            Issued {{ $letter->updated_at->format('d M Y, h:i A') }}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="{{ Storage::url($letter->generated_file_path) }}?v={{ $letter->updated_at->timestamp }}" target="_blank"
                           class="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white font-bold py-2.5 px-4 rounded-xl shadow-sm transition-all text-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
        ...
        <ul class="space-y-3">
            ...
            <li class="flex items-start gap-2.5 text-sm text-gray-500">
                <svg class="w-5 h-5 text-stormy-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                <span>Your appointment letter is issued by the company after your posting letter has been validated, and is separate from the endorsement process.</span>
            </li>
            <li class="flex items-start gap-2.5 text-sm text-gray-500">
                <svg class="w-5 h-5 text-stormy-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
